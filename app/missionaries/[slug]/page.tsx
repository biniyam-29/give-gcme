...
export default function MissionaryDetailPage({ params }: MissionaryDetailPageProps) {
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                ...
                <div className="md:col-span-2">
                  <h1 className="text-4xl font-bold text-stone-800 mb-4">{missionary.name}</h1>
                  ...
                  <div className="flex items-center text-stone-600 mb-4">
                    ...
                    {missionary.years} of faithful service
                  </div>
                  <Badge className="bg-amber-100 text-amber-800 mb-6">{missionary.focus}</Badge>
                  <p className="text-lg text-stone-700 mb-6">{missionary.shortBio}</p>
                  <div>
                    <Button
                      className="bg-amber-600 hover:bg-amber-700 text-white w-full sm:w-auto px-8 py-3"
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <Card className="bg-white border-stone-200 mb-8">
                  <CardHeader>
                    <CardTitle className="text-2xl text-stone-800">Their Story</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="prose prose-stone max-w-none">
                      {missionary.fullBio.split("\n\n").map((paragraph, index) => (
                ...
                <Card className="bg-white border-stone-200">
                  <CardHeader>
                    <CardTitle className="text-2xl text-stone-800">Recent Updates</CardTitle>
                  </CardHeader>
                  <CardContent>
                      ...
                      {missionary.recentUpdates.map((update, index) => (
                        <div key={index} className="border-l-4 border-amber-600 pl-4">
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="font-semibold text-stone-800">{update.title}</h4>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white border-stone-200">
                  <CardHeader>
                    <CardTitle className="text-xl text-stone-800">Contact Information</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div className="flex items-center text-stone-600">
                      <Mail className="w-4 h-4 mr-3 text-amber-600" />
                      <a href={`mailto:${missionary.email}`} className="hover:text-amber-600 transition-colors">
                        {missionary.email}
                      </a>
                    </div>
                    <div className="flex items-center text-stone-600">
                    ...
                    <div className="flex items-center text-stone-600">
                      <Globe className="w-4 h-4 mr-3 text-amber-600" />
                      <a href={`https://${missionary.website}`} className="hover:text-amber-600 transition-colors">
                        {missionary.website}
                      </a>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-white border-stone-200">
                  <CardHeader>
                    <CardTitle className="text-xl text-stone-800">Prayer Requests</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2">
                      {missionary.prayerRequests.map((request, index) => (
                        <li key={index} className="text-stone-700 text-sm flex items-start">
                ...
                <Card className="bg-white border-stone-200">
                  <CardHeader>
                    <CardTitle className="text-xl text-stone-800">Support Needs</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {missionary.supportNeeds.map((need, index) => (
                        <div key={index} className="border-b border-stone-200 pb-3 last:border-b-0">
                          <div className="flex justify-between items-start mb-1">
                            <h4 className="font-medium text-stone-800">{need.item}</h4>
                            <span className="font-semibold text-amber-600">{need.amount}</span>
                          </div>
                          <p className="text-sm text-stone-600">{need.description}</p>
                        </div>
                      ))}
                    </div>
                    <Button
