...
export default function NewsletterPage() {
  ...
  const interestOptions = [
    {
      id: "missionary-updates",
      label: "Missionary Updates",
      description: "Stories and updates from our missionaries",
    },
    {
      id: "project-progress",
      label: "Project Progress",
      description: "Updates on current projects and their impact",
    },
    {
      id: "prayer-requests",
      label: "Prayer Requests",
      description: "Weekly prayer needs and answered prayers",
    },
    {
    ...
    },
    {
      id: "events",
      label: "Events & News",
      description: "Upcoming events and organizational news",
    },
  ];
  ...
  const newsletterFeatures = [
    {
      ...
      description:
        "Get to know our missionaries through personal stories and ministry updates",
    },
    {
      icon: Heart,
      title: "Impact Reports",
      description:
        "See exactly how your support is transforming communities across Ethiopia",
    },
    {
      icon: Calendar,
      title: "Prayer Calendar",
      description:
        "Receive specific prayer requests and praise reports from the field",
    },
    {
      icon: Mail,
      title: "Exclusive Content",
      description:
        "Access photos, videos, and stories not shared anywhere else",
    },
  ];
        ...
        <Card className="max-w-md mx-auto text-center">
          ...
          <CardContent>
            <p className="text-stone-600 mb-6">
              ...
              first update within the next week, and we'll keep you informed
              about the amazing work happening in Ethiopia.
            </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-stone-600 max-w-3xl mx-auto">
                Join thousands of supporters who receive regular updates about
                our missionaries, projects, and the incredible transformation
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-stone-600 max-w-2xl mx-auto">
                Our newsletter is packed with inspiring content that keeps you
            ...
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-stone-600">
                  Choose what you'd like to hear about and how often. We respect
                  your inbox and will never spam you.
                </p>
              </div>
              ...
              <Card className="bg-white border-stone-200">
                <CardContent className="p-8">
                  <blockquote className="text-center text-lg text-stone-700 italic mb-4">
                    "The newsletter keeps me connected to the amazing work
                    happening in Ethiopia. Every update reminds me why I became
                    a monthly partner. The stories are so encouraging and the
                    prayer requests help me pray specifically for real needs."
                  </blockquote>
                  <div className="text-center">
